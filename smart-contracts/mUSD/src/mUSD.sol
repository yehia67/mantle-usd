...
contract mUSD is IMUSD, ERC20, Ownable {
    ...
    function unlockCollateral(uint256 amount) external {
        ...
        if (debtBalances[msg.sender] > 0) {
            ...
            uint256 debtIn18Decimals = debtBalances[msg.sender] * 1e12;
            uint256 healthFactor = (collateralValueUsd * PERCENTAGE_SCALE) / debtIn18Decimals;
    ...
    function liquidate(address account) external {
        ...
        uint256 debtIn18Decimals = debt * 1e12;
        uint256 requiredCollateralValue = (debtIn18Decimals * BPS_DENOMINATOR) / mintPercentageBps;
    ...
    function getHealthFactor(address account) external view returns (uint256) {
        ...
        uint256 debtIn18Decimals = debt * 1e12;
        return (collateralValueUsd * PERCENTAGE_SCALE) / debtIn18Decimals;
    }
