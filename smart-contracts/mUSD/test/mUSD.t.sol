...
contract TestMUSD is Test {
    ...
    function testLockAndUnlockCollateralFlow() public {
        ...
        // mUSD has 6 decimals, so convert expected mint from 18 to 6 decimals
        uint256 expectedMint = ((collateralToLock * COLLATERAL_PRICE / 1e18) * MINT_PERCENTAGE / 10_000) / 1e12;
